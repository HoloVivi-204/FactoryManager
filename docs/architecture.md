...
1. Source code và cấu hình trong repository là nguồn sự thật cho hành vi
   **Current**.
2. [PRD v2.5](prd.md) là nguồn sự thật cho nhu
   cầu, phạm vi, vai trò và quy tắc nghiệp vụ **Target**.
3. [TDD v1.5](technical-design.md) là nguồn sự thật cho kiến
...
|---|---|
| Frontend | React 19, TypeScript, Vite và React Router trong [`apps/frontend`](../apps/frontend/) |
| Backend | Java 17, Spring Boot 4.1, Spring MVC, Validation, Security, OAuth2 Resource Server trong [`apps/backend/pom.xml`](../apps/backend/pom.xml) |
...
Dùng ExecPlan theo [exec-plans.md](exec-plans.md) khi thay đổi kéo dài nhiều mốc và cần
