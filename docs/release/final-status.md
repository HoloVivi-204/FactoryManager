...
Chi tiết 47 Must: [must-traceability.md](must-traceability.md).
...
| 2026-07-30 | Backend test phase | `apps/backend/target/surefire-reports/com.factory.management.FactoryManagementApplicationTests.txt` | Fail | 1 test, 0 failure, 1 error; PostgreSQL yêu cầu SCRAM authentication nhưng test không cung cấp password. |
| 2026-07-29 | Backend test coverage | `apps/backend/src/test/java/com/factory/management/FactoryManagementApplicationTests.java:6` | Missing | Chỉ có `@SpringBootTest contextLoads`; không có unit/integration/contract/security/performance/E2E suite. |
