...
File Excel mẫu đã điền sẵn dữ liệu ngày `2026-07-12`: [staging-report-template.xlsx](examples/staging-report-template.xlsx).
...
- Chi tiết đầy đủ: [api/staging-report-excel.md](api/staging-report-excel.md).
