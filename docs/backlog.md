...
`docs/feature-matrix.csv` là requirement matrix, mỗi dòng đúng một FR; file này
...
- [ ] Quyết định được phản ánh vào `docs/decisions.md`, PRD hoặc phụ lục được PRD tham chiếu.
