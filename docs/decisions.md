...
1. [PRD v2.5](prd.md) quyết định nghiệp vụ.
2. [TDD v1.5](technical-design.md) quyết định/đề xuất kỹ thuật.
...
4. [architecture.md](architecture.md) mô tả Current/Target và
   [api-contracts.md](api-contracts.md) mô tả contract/gap.
...
test liên quan. Chỉ tạo ExecPlan theo [exec-plans.md](exec-plans.md) nếu thay đổi kéo dài
