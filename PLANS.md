...
- requirement IDs từ
  [PRD v2.5](PRD_He_thong_hieu_suat_nha_may.md);
- target design từ
  [TDD v1.5](TDD_He_thong_hieu_suat_nha_may.md);
- Current/Target trong [ARCHITECTURE.md](ARCHITECTURE.md);
- public contract trong [API_Contracts.md](API_Contracts.md);
...
tiếp tiến độ dự án vào `PLANS.md`.
...
- `factory-management/src/main/.../SomeController.java`: route và authorization.
- `factory-management/src/main/.../SomeService.java`: transaction/state transition.
- `factory-management-frontend/src/api/...`: consumer contract.
...
Nếu không có blocker, ghi lý do và dẫn DECISIONS.md. Không tạo quyết định mới
...
- Product requirements:
  [PRD_He_thong_hieu_suat_nha_may.md](PRD_He_thong_hieu_suat_nha_may.md).
- Technical target:
  [TDD_He_thong_hieu_suat_nha_may.md](TDD_He_thong_hieu_suat_nha_may.md).
