import type { PageKey, Role } from '../../shared/types'
import EmployeePortalPage from '../../features/employee/pages/EmployeePortalPage'
import AdminMasterPage from '../../features/admin/pages/AdminMasterPage'
import ReportsPage from '../../features/production-reports/pages/ReportsPage'
import OperationalPage from '../../features/operations/pages/OperationalPages'
import TeamLeaderReportPage from '../../features/production-reports/pages/TeamLeaderReportPage'
import ApprovalPage from '../../features/production-reports/pages/ApprovalPage'
import RoleOverviewPage from '../../features/dashboard/pages/RoleOverviewPage'
import FinancePage from '../../features/finance/pages/FinancePage'
import HrManagementPage, { type HrView } from '../../features/hr/pages/HrManagementPage'
import MaintenancePage, { type MaintenanceView } from '../../features/maintenance/pages/MaintenancePage'
...
export default function AppRoutes({ role, page }: { role: Role; page: PageKey }) {
  ...
  if (role === 'EMPLOYEE' || (role === 'TEAM_LEADER' && page === 'notifications')) {
